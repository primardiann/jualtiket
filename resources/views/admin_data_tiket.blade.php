...
<aside id="default-sidebar"
    ...
    aria-label="Sidebar">
    <div class="h-full px-3 pb-4 overflow-y-auto dark:bg-white-700 dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="#"
                    class="flex items-center p-3 text-gray-900 rounded-lg dark:text-white border border-blue-400 hover:bg-gray-100 dark:hover:bg-gray-700 group">
            ...
            <br>
            <a href="#"
                class="flex justify-items-center align-items-center p-3 text-gray-900 border border-blue-400 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
    ...
    <div class="p-8 pt-20 sm:ml-64 fixed-top"><br>
        ...
        <div class="pt-3 grid grid-cols-2 gap-4 mb-4">
            <div
                ...
                <div class="p-5">
                    <a href="#">
                        <h3 class="mb-2 font-bold tracking-tight text-gray-900 dark:text-white">The Eras
                            Tour</h3>
                    </a>
                    <a href="#">
                        <h3 class="mb-2 font-normal tracking-tight text-gray-600 dark:text-gray-400">19 Februari 2024
                        </h3>
                    </a>
                    <a href="#">
                        <h3 class="mb-3 font-bold tracking-tight text-gray-900 dark:text-white">Harga Tiket</h3>
                    </a>
                    <!-- <h3 class="mb-3 font-normal text-gray-700 dark:text-gray-400">19 Februari 2024</h3> -->
                    <a href="#"
        ...
        <div class="grid grid-cols-3 gap-4 mb-4">
            <div class="max-w-xs p-4 pt-2 bg-white border-2 border-black-200 rounded-lg">
                <a href="#">
                    <h3 class="font-bold tracking-tight text-gray-900 dark:text-white">VIP</h3>
                </a>
                <p class="font-normal dark:text-gray-400">stok awal 100</p>
                <p class="font-normal dark:text-gray-400">tiket terjual 30</p>
                <p class="mb-2 font-normal dark:text-gray-400">sisa stok 70</p>
                <a href="#"
            ...
            <div class="max-w-xs p-4 pb-4 pt-2 bg-white border-2 border-black-200 rounded-lg">
                <a href="#">
                    <h3 class="font-bold tracking-tight dark:text-white">Reguler</h3>
                </a>
                <p class="font-normal dark:text-gray-400">stok awal 100</p>
                <p class="font-normal dark:text-gray-400">tiket terjual 30</p>
                <p class="mb-2 font-normal dark:text-gray-400">sisa stok 70</p>
