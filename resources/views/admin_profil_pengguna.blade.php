    ...
    <div class="p-4 sm:ml-64">
        <div class="container mx-auto px-4 py-12">
            <form class="mt-8">
                ...
                <div class="mb-4">
                    <label for="fotopengguna" class="block text-gray-700 text-sm font-semibold mb-2">Foto
                        Pengguna</label>
                    <input type="file" id="fotopengguna"
                        class="form-input w-full rounded-md border border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                </div>
                <div class="mb-4">
                    <label for="ganti password" class="block text-gray-700 text-sm font-semibold mb-2">Ganti
                        Password</label>
                </div>
                <form class="mt-8">
                    <div
                        ...
                        <div class="mb-4 mt-4 ml-3 mr-3">
                            <label for="password" class="block text-gray-700 text-sm font-medium mb-2">Password
                                Baru</label>
                ...
                <div class="container flex justify-content: flex-end">
                    <button type="button"
                        class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Ubah
                        password</button>
                </div>
