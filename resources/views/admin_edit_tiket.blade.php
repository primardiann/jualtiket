        ...
        <div class="p-8 pt-20 sm:ml-64 fixed-top">
            <div class="pt-3 grid grid-cols-2 gap-4 mb-4">
                ...
                <div class="items-center justify-center border border-gray-500 shadow">
                    ...
                    <form class="p-2 m-2 mt-1">
                        <div class="mb-4">
                            <label for="namaKonser" class="block text-gray-500 text-sm font-medium mb-2">Judul Konser</label>
                            <input
                                type="text"
                                id="namaKonser"
                        ...
                        <div class="mb-4">
                            <label for="tanggalKonser" class="block text-gray-500 text-sm font-medium mb-2">Tanggal Konser</label>
                            <input
                                type="date"
                                id="tanggalKonser"
                                class="form-input w-full rounded-md border border-gray-400 focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <div class="mb-4">
                            <label for="lokasiKonser" class="block text-gray-500 text-sm font-medium mb-2">Lokasi Konser</label>
                            <input
                                type="text"
                                id="lokasiKonser"
                                class="form-input w-full rounded-md border border-gray-400 focus:border-indigo-500 focus:ring-indigo-500"
                        ...
                        <div class="mb-4">
                            <label for="waktuKonser" class="block text-gray-500 text-sm font-medium mb-2">Waktu Konser</label>
                            <input
                                type="time"
                                id="waktuKonser"
                                class="form-input w-full rounded-md border border-gray-400 focus:border-indigo-500 focus:ring-indigo-500">
                        ...
                        <div class="mb-4">
                            <label for="namaArtis" class="block text-gray-500 text-sm font-medium mb-2">Nama Panggung Artis</label>
                            <input
                                type="text"
                                id="namaArtis"
                                class="form-input w-full rounded-md border border-gray-400 focus:border-indigo-500 focus:ring-indigo-500"
                        ...
                        <div class="mb-4">
                            <label
                                for="deskripsiKonser"
                                class="block text-gray-500 text-sm font-medium mb-2">Deskripsi Konser</label>
                            <textarea
                                id="deskripsiKonser"
                        ...
                        <div class="mb-4">
                            <label
                                for="deskripsiKonser"
                                class="block text-gray-500 text-sm font-medium mb-2">Syarat dan Ketentuan Konser</label>
                            <textarea
                                id="deskripsiKonser"
                                class="form-textarea w-full rounded-md border border-gray-400 focus:border-indigo-500 focus:ring-indigo-500"
                                rows="5"
                        ...
                        <div class="mb-2">
                            <!-- <center> -->
                            <label for="kategoriTiket" class="block text-gray-900 text-sm font-medium mb-2">Menambahkan Kategori Tiket</label>
                            <!-- </center> -->
                        </div>
                        ...
                        <form class="mt-8">
                            <div
                                ...
                                <div class="mb-4 mt-4 ml-3 mr-3">
                                    <label for="kateogri1" class="block text-gray-500 text-sm font-medium mb-2">Nama Jenis Kategori</label>
                                    <input
                                        type="text"
                                        id="kateogri1"
                                        class="form-input w-full rounded-md border border-gray-400 focus:border-indigo-500 focus:ring-indigo-500"
                        ...
                        <div class="">
                            <div class="pt-3 grid grid-cols-2 gap-4">
                                <div class="m-2">
                                    <label
                                        for="tanggalPeluncuran"
                                        class="block text-gray-500 text-sm font-medium mb-2">Tanggal Peluncuran Tiket</label>
                                    <input type="date" class="form-control" id="tanggalPeluncuran">
                                </div>

                                <div class="m-2">
                                    <label for="tanggalTutup" class="block text-gray-500 text-sm font-medium mb-2">Tanggal Tutup Penjualan Tiket</label>
