                ...
                <tbody>
                    <div>
                        <tr class="bg-white dark:bg-gray-800">
                            <th
                                ...
                                <p class="px-3">19 February 2024</p>
                            </th>
                            <td class="px-6">
                                Waktu Pembayaran
                            </td>
                    ...
                    <tr class="bg-white dark:bg-gray-800">
                        <th
                            ...
                            <p class="px-3">Microsoft Surface Pro</p>
                        </th>
                        <td class="px-6 py-4">
                            22/10/23
                        </td>
                    ...
                    <tr class="bg-white dark:bg-gray-800">
                        ...
                        <td class="px-6 py-4">
                            ...
                            <p class="flex">4 Tiket</p>
                        </td>
                    </tr>
                </tbody>
                <tr scope="col" class="px-6 py-3 rounded-e-lg items-center">
                    <td class="px-6 py-4">
                        <div class="flex justify-end">
                            <img
                                class="w-40 h-40 flex-center mx-auto items-center rounded-lg ml-7"
        ...
        <div class="width: 400px; height: 500px; p-7" style="width: 100%;">
            <table
                ...
                <tr scope="col" class="px-6 py-3 rounded-e-lg items-center">
                    <td class="px-6 py-4">
                        <div class="flex justify-end">
                            <img class="w-40 h-40 rounded-lg" src="/images/Taylor-Swift.jpg" alt="">
                        </div>
                    </td>
                </tr>
            </table>
