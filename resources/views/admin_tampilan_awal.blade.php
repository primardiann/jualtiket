...
<div id="mega-menu-icons" class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1">
    <ul class="flex flex-col mt-4 font-medium md:flex-row md:mt-0 md:space-x-8 rtl:space-x-reverse">
        <li>
            ...
            <div id="toast-top-left" class="fixed  items-center w-full max-w-xs p-0  rounded-lg shadow top-100 left-5"
                role="alert">
...
<br>
<ol>
    <span class=" text-2xl font-bold whitespace-nowrap dark:text-white" style="margin-left: 100px">Konser Aktif</span>
</ol>
<br>
<div class="flex gap-5" style="margin-left: 100px">
    <div class="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="p-5">
            <a href="#">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">The Eras Tour</h5>
            </a>
    ...
    <head>
        ...
        <title>Simple Carousel with Add Item Button</title>
        <style>
    ...
    <body>
        ...
        <button class="addItemButton" onclick="addItem()">
        ...
        <script>
            function addItem() {
                ...
                newItem.classList.add('carouselItem');
