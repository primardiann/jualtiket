            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <a
                        ...
                        <span
                            class="flex text-center justify-content-center align-items-center p-3 text-gray-900 rounded-lg group ms-3">Dashboard</span>
                    </a>
                </li>
                <li>
                    <a
        ...
        <div class="container mx-auto px-4 py-12">
            ...
            <form
                ...
                <div class="mb-4">
                    <label
                        for="deskripsiKonser"
                        class="block text-gray-700 text-sm font-medium mb-2">Deskripsi Konser</label>
                    <textarea
                        id="deskripsiKonser"
                        name="deskripsi"
                        class="form-textarea w-full rounded-md border border-gray-300 focus:border-indigo-500 focus:ring-indigo-500"
                        rows="5"
                        placeholder="Masukkan deskripsi konser"></textarea>
                </div>
                ...
                <div class="mb-3 mt-4">
                    <label
                        ...
                        class="block text-gray-700 text-sm f
            ont-medium mb-2">Tanggal Peluncuran Tiket</label>
                    <input
                        type="date"
                        class="form-control"
                        id="tanggalPeluncuran"
                        name="tanggal_awal">
                </div>
                <div class="mb-3">
            ...
            <div class="mb-4">
                <center>
                    <label for="kategoriTiket" class="block text-gray-700 text-sm font-medium mb-2">Menambahkan Kategori Tiket</label>
                </center>
            </div>
            <div class="mb-4">
            ...
            <form class="mt-8" action="{{ route('tikets.store') }}">
                <div
                    class="form-input w-full rounded-md border border-gray-300 focus:border-indigo-500 focus:ring-indigo-500">
                    ...
                    <div class="mb-4 mt-4 ml-3 mr-3">
                        ...
                        <div class="mb-4 mt-4 ">
                            <label for="stok1" class="block text-gray-700 text-sm font-medium mb-2">Stok Tiket Kategori</label>
                        </div>
                        <div class="input-group">
                            <input
                                type="number"
