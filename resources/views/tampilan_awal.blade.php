        ...
        <div class="flex flex-wrap justify-center gap-4">
            ...
            <div
                ...
                <div class="p-5">
                    <a href="#">
                        <h5
                            class="mb-2 text-2xl font-bold tracking-tight text-gray-900">Bruno Mars</h5>
                    </a>
                    <p class="mb-3 font-normal text-gray-700">26 juli 2024</p>
                    <a
                        href="{{ route('deskripsi') }}"
                        class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                        Harga Tiket
            ...
            <div
                ...
                <div class="p-5">
                    <a href="#">
                        <h5
                            class="mb-2 text-2xl font-bold tracking-tight text-gray-900">Daniel Caesar</h5>
                    </a>
                    <p class="mb-3 font-normal text-gray-700">30 December 2024</p>
                    <a
                        href="{{ route('deskripsi') }}"
                        class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                        Harga Tiket
