      ...
      <ul class="space-y-2 font-medium">
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
               ...
               <span class="ms-3">Data Tiket</span>
            </a>
         </li>
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
               ...
               <span class="flex-1 ms-3 mb-3 whitespace-nowrap">Data Pembeli</span>
  ...
  <div class="container mx-auto px-4 py-12 mt-3">
    ...
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
        ...
        <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
            ...
            <li>
                <button type="button" class="inline-flex w-full px-4 py-2 hover:bg-gray-100">Kategori 1</button>
            </li>
            <li>
                <button type="button" class="inline-flex w-full px-4 py-2 hover:bg-gray-100">Kategori 2</button>
            </li>
            <li>
                <button type="button" class="inline-flex w-full px-4 py-2 hover:bg-gray-100">Kategori 3</button>
            </li>
            <li>
                <button type="button" class="inline-flex w-full px-4 py-2 hover:bg-gray-100">Kategori 4</button>
            </li>
            </ul>
        </div>
